...
def test_filter_by_no_state(status_no_state):
    assert filter_by_state(status_no_state, state="EXECUTED") == []


def test_sort_by_same_date(same_date):
...
@pytest.mark.parametrize(
    "list_of_dicts, descending, expected", [
        ([
            {"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
            {"id": 939719570, "state": "EXECUTED", "date": "2018-06-30T02:08:58.425572"},
            {"id": 594226727, "state": "CANCELED", "date": "2018-09-12T21:27:25.241689"},
...
def test_sort_by_date(list_of_dicts, descending, expected):
    assert sort_by_date(list_of_dicts, descending) == expected
