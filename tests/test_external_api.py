...
class TestTransactionAmount(unittest.TestCase):
    ...
    def test_get_transaction_amount_usd(self, mock_get):
        ...
        # Проверяем результат и то, что API был вызван с нужными параметрами
    ...
    @patch('src.external_api.requests.get')
    def test_get_transaction_amount_api_error(self, mock_get):
    ...
    def test_get_transaction_amount_empty(self):
